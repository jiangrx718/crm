...
type CRMRolePermission struct {
	...
	RolePermissionId string    `gorm:"column:role_permission_id;type:char(36);unique;comment:业务主键;" json:"role_permission_id"`
	RoleId           string    `gorm:"column:role_id;type:char(36);default:'';comment:角色ID;" json:"role_id"`
	PermissionId     string    `gorm:"column:permission_id;type:char(36);default:'';comment:权限ID" json:"permission_id"`
