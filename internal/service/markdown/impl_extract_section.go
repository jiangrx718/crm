...
func (s *Service) MarkdownExtractSection(ctx context.Context, markdown string) (services.Result, error) {
	...
	paragraphTexts := md.ExtractParagraphsAsText(markdown)
	...
	return services.Success(ctx, sectionInfo)
}
